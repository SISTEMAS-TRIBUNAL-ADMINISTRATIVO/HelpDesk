...
<head lang="en">
	...
	<title>TAPJE | Soporte :: Recuperar Contraseña</title>
        ...
        <div class="page-center-in">
            <div class="container-fluid">
                <form class="sign-box reset-password-box">
                    ...
                    <button type="button" id="btnenviar" class="btn btn-rounded">Enviar</button> or <a type="button" class="btn btn-rounded" href="../../index.php">Regresar</a>
                </form>
            </div>
        </div>
    </div><!--.page-center-->
